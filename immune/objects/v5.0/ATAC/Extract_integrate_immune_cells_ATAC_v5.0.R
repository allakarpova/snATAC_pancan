...
saveRDS(integrated, paste0('PanImmune_integrated_object_new_peaks_', add_filename, '_chemistry.rds'))

fwrite(cbind(Embeddings(integrated, reduction='umap'), integrated@meta.data), 
       paste0('PanImmune_integrated_object_new_peaks_', add_filename, '_chemistry_matadata.tsv'),
       sep='\t', row.names = T)
