...
output_dir = "/diskmnt/Projects/ccRCC_scratch/RCC_snRNA_2022/Results/output/" + "RCC_xenium_squidpy_auto1" + "/" + \
    section_id + "/" + args["celltype_version"] + "/"
try:
...
## load clinical
clinical = pd.read_csv(args["clinical_df"],
                     sep='\t')
# clinical["Output_file_path"]
input_data_folder = clinical.Output_file_path[clinical["Section_ID"] == section_id].iloc[0]
print("Input data folder",input_data_folder)
###
