...
obj$Test.column <- case_when(colnames(obj) %in% cells.trunc ~ 'Mutant',
...
fwrite(da_peaks, glue::glue("{driver}_Mut_vs_WT.Pooled.pct.0.05.fCh.0.1.20230329_downsampled200_limited_cancers.tsv"),
       sep="\t",row.names=FALSE)
